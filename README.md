...
별도의 외부 라이브러리 설치 없이 Python 3 기본 표준 라이브러리만으로 실행할 수 있습니다.
...
프로그램은 루트 디렉터리의 `state.json` 파일을 사용합니다.
...
docs/screenshots/play_quiz.png
docs/screenshots/git_log.png
docs/screenshots/git_clone_pull.png
```
